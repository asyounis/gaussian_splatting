...
do
	...
	# Run it!
	python3 render.py --model_path /home/ali/Development/gaussian_splatting/data/Replica/office0/ --source_path /home/ali/Development/particle_nvs_slam/data/Replica/processed/office0 --data_device cpu
